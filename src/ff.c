...
FRESULT chk_lock (	/* Check if the file can be accessed */
	F_DIR* dj,		/* Directory object pointing the file to be checked */
...
UINT inc_lock (	/* Increment file open counter and returns its index (0:int error) */
	F_DIR* dj,	/* Directory object pointing the file to register or increment */
...
static
FRESULT dir_sdi (
	F_DIR *dj,		/* Pointer to directory object */
...
static
FRESULT dir_find (
	F_DIR *dj			/* Pointer to the directory object linked to the file name */
)
{
	FRESULT res;
	BYTE c, *dir;
...
static
FRESULT dir_read (
	F_DIR *dj			/* Pointer to the directory object that pointing the entry to be read */
)
{
	FRESULT res;
	BYTE c, *dir;
...
FRESULT dir_register (	/* FR_OK:Successful, FR_DENIED:No free entry or too many SFN collision, FR_DISK_ERR:Disk error */
	F_DIR *dj				/* Target directory with object name to be created */
)
{
	FRESULT res;
	BYTE c, *dir;
...
FRESULT dir_remove (	/* FR_OK: Successful, FR_DISK_ERR: A disk error */
	F_DIR *dj				/* Directory object pointing the entry to be removed */
)
{
	FRESULT res;
#if _USE_LFN	/* LFN configuration */
...
static
FRESULT create_name (
	F_DIR *dj,			/* Pointer to the directory object */
...
FRESULT follow_path (	/* FR_OK(0): successful, !=0: error code */
	F_DIR *dj,			/* Directory object to return last directory and found object */
...
FRESULT f_opendir (
	F_DIR *dj,			/* Pointer to directory object to create */
	const TCHAR *path	/* Pointer to the directory path */
)
{
	FRESULT res;
...
FRESULT f_readdir (
	F_DIR *dj,			/* Pointer to the open directory object */
		...
		if (res == FR_OK) {					/* The object is accessible */
			...
			if (res == FR_OK && (dir[DIR_Attr] & AM_DIR)) {	/* Is it a sub-dir? */
				if (dclst < 2) {
					...
					mem_cpy(&sdj, &dj, sizeof (F_DIR));	/* Check if the sub-dir is empty or not */
					sdj.sclust = dclst;
	...
	if (res == FR_OK) {
		...
		if (res == FR_OK) {						/* Old object is found */
			if (!djo.dir) {						/* Is root dir? */
				...
				mem_cpy(&djn, &djo, sizeof (F_DIR));		/* Check new object */
